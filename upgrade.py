...
class Upgrade:
    def __init__(self, player):
        ...
        self.player = player
        self.atribute_nr = len(player.stats)
        self.atribute_names = list(player.stats.keys())
    ...
    def input(self):
        ...
        if self.can_move:
            if keys[pygame.K_RIGHT] and self.selection_index < self.atribute_nr:
    ...
    def display(self):
        ...
        for index, item in enumerate(self.item_list):
            # get attributes
            name = self.atribute_names[index]
